...
[배포된 과제 링크 — https://market.zynkimland.com](https://market.zynkimland.com)
(AI Agent의 응답이 예상보다 느리게 나올 수 있습니다. 개발자도구 로그를 보시면서 기다리시는걸 권장드립니다...)

본 과제는 **AI 기반 쇼핑 어시스턴트의 최소 기능 제품(MVP)** 구현을 목표로 하였습니다.
