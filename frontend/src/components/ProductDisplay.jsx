...
const ProductItem = ({ product }) => {
  return (
    <div className="border border-gray-200 rounded p-3 flex flex-col bg-gray-50 cursor-pointer hover:bg-gray-100 transition-colors" onClick={() => window.open(product.detailLink, '_blank')}>
      <img
